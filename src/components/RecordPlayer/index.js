...
const RecordPlayer = ({className, playing, onClick}) => {
    ...
    return (<div className={`${className} ${styles.player}`}>
        <Image src="https://framerusercontent.com/images/vVd897dq9a3NfXBgLf0vXNFfpB0.webp" alt="" priority sizes='28vmax' fill/>
        <Image src="https://framerusercontent.com/images/XcxoBsaaXbRA34sHY4OH8eIn60.webp" alt="" priority sizes='(max-width: 1200px) 54vw, 18vw' fill className={`${styles.needle} ${styles.needle_base}`} />

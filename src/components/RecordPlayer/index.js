...
const RecordPlayer = ({className, playing, onClick}) => {
    ...
    return (<div className={`${className} ${styles.player}`}>
        <Image src="https://framerusercontent.com/images/vVd897dq9a3NfXBgLf0vXNFfpB0.webp" alt="" sizes='28svmax' fill/>
        ...
        <Image src="https://framerusercontent.com/images/uFFvuLhLGlvEmeGjj9m2rQbbNto.webp" alt="" fill sizes='18.43svmax' className={styles.reflection} onClick={onClick} />
    </div>);
}

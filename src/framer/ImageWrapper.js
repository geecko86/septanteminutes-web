...
const ImageOffsetWrapper = (props) => {
    ...
    const { motionValue, src, sizes, onReady, ...newProps } = props;
    const translateX = useOffset(ref, motionValue, 140, src, onReady);
    
    return (<div {...newProps} ref={ref}>
        <motion.div style={{ position: "relative", translateX, height: "100%", width: "100%" }}>
            <Image src={src} alt="" fill sizes={props.sizes || "10vw"} />
        </motion.div>
    </div>)
};
...
export const Chair = (props) => {
    const comp = (<ImageWrapper {...props} src="https://framerusercontent.com/images/1rnV14P8MhyhWjPOrSeUNIVvs.png" sizes="50vh" />);
    return {...comp, displayName: "Chair"};
};

export const Pen = (props) => {
    const comp = (<ImageWrapper {...props} src="https://framerusercontent.com/assets/Fx6XFRFwE2EscXTGW81QBWrLYEs.webp" sizes="30vh" />);
    return {...comp, displayName: "Pen"};
};

export const Vinyl_Base = (props) => {
    const comp = (<ImageWrapper {...props} src="https://framerusercontent.com/images/FagAAtLngco0ruyleiYmdGuaE8.webp" sizes="30vh" />);
    return {...comp, displayName: "VinylBase"};
}

export const Plant0 = (props) => {
    const comp = (<ImageOffsetWrapper {...props} src="https://framerusercontent.com/images/R8Kn20M0nzPmEcfud1mHzG8Uyk.png" />);
    return {...comp, displayName: "Plant0"};
};

export const Plant1 = (props) => {
    const comp = (<ImageOffsetWrapper {...props} src="https://framerusercontent.com/images/hxRiihE2Zoimhej95EBT69kprc.png" />);
...
export const Plant3 = (props) => {
    const comp = (<ImageOffsetWrapper {...props} src="https://framerusercontent.com/images/1HpjPEOfsK4TSxEz6aRVR1QUmhs.png" />);
    return {...comp, displayName: "Plant3"};
};

export const Plant4 = (props) => {
    const comp = (<ImageOffsetWrapper {...props} src="https://framerusercontent.com/images/yhEIvU554Dvkhmnmw59O6yPu60.png" />);
    return {...comp, displayName: "Plant4"};
};

export const Eggchair = (props) => {
    const comp = (<ImageOffsetWrapper {...props} src="https://framerusercontent.com/images/p7a4OJaiiEBm2LbB08atc4nEjM.png" />);
